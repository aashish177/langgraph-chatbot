...
import SPAPIClient from './amazon-mcp-server/sp-api-client.js';
import dotenv from 'dotenv';

// Load environment variables from amazon-mcp-server/.env
dotenv.config({ path: './amazon-mcp-server/.env' });
...
async function testConnection() {
  ...
  try {
    ...
    console.log('  Response:', JSON.stringify(orders, null, 2).substring(0, 200) + '...');
    console.log();
